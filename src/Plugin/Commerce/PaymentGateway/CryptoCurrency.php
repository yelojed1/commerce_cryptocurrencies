...
/**
 * Provides the Crypto Currency payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "crypto_currency_checkout",
 *   label = @Translation("Crypto Currency (Express Checkout)"),
 *   display_label = @Translation("Crypto Currency"),
 *    forms = {
 *     "add-payment-method" = "Drupal\commerce_crypto\PluginForm\CryptoCheckoutForm",
 *   },
 ...
 * )
 */
class CryptoCurrency extends OnsitePaymentGatewayBase implements CryptoCurrencyInterface {
